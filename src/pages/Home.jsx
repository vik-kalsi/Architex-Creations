...
function Home() {
  return (
    <>
      ...
      <div className='w-72 space-y-2 md:w-96 lg:w-full lg:mb-16'>
      ...
      <div className='pt-6'>
        <h1 className='font-bold text-2xl	md:text-5xl lg:pb-6'>What we offer</h1>

        <div className='space-y-10 lg:flex lg:space-x-7'>
          <div className='border-4 border-[#dca54c] w-52 p-3 md:w-80'>
